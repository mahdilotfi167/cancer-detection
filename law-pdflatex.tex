...
\begin{document}
  ...
  int main(int argc, char **argv)
  {
    ...
    \begin{frame}[t]{What Is Cancer ?}
      ...
      We are made up of trillions of cells that over your lifetime normally grow and divide as needed. When cells are abnormal or get old, they usually die. Cancer starts when something goes wrong in this process.
      \vspace{8mm}
    ...
    \begin{frame}{Types of Cancers}
      \framesubtitle{an overview of common cancer types}
      \begin{columns}[onlytextwidth]
        \column{.5\textwidth}
          \begin{itemize}
            \item Bladder Cancer
            \item Breast Cancer
            \item Colon and Rectal Cancer
            \item Endometrial Cancer
            \item Kidney Cancer
            \item Leukemia
            \begin{itemize}
              \item Acute Lymphoblastic Leukemia
            \end{itemize}
          \end{itemize}
          \column{.5\textwidth}
          \begin{itemize}
