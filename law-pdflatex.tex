...
\begin{document}
  ...
  \AtBeginSection[]{% Printt an outline at the beginning of sections
    ...
    \begin{frame}[t]{Supervised Machine Learning}
      ...
      \begin{tikzpicture}[overlay,remember picture]
        \node[anchor=south east,xshift=-20pt,yshift=20pt]
          at (current page.south east) {
    ...
    \begin{frame}[t]{Unsupervised Machine Learning}
      ...
      \begin{tikzpicture}[overlay,remember picture]
        \node[anchor=south east,xshift=-20pt,yshift=25pt]
          at (current page.south east) {
    ...
    \begin{frame}[t]{Unsupervised Machine Learning}
      It is based on training data. we train the machines using the "labeled" dataset, and based on the training, the machine predicts the output. 
